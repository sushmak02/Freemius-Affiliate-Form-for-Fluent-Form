<?php
    ...
    define('FS_SDK__USER_AGENT', 'fs-php-' . Freemius_Api_Custom_Base_Custom::VERSION);
    ...
    if ( class_exists( 'Freemius_Api_Custom' ) ) {
        return;
    }

    class Freemius_Api_Custom extends Freemius_Api_Custom_Base_Custom
    {
        /**
